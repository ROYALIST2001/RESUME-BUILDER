         ...
         <div className="max-w-7xl mx-auto px-4 pb-8">
            <div className="grid lg:grid-cols-12 gap-8">
               ...
               <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
                  <div className="bg-gray-900 rounded-lg shadow-sm border border-gray-800 p-6 pt-1">
                        ...
                        <div className="flex items-center">
                           {activeSectionIndex !== 0 && (
                              <button
                                 ...
                                 className="flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-300 hover:bg-gray-800 transition-all"
                           ...
                           <button
                              ...
                              className={`flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-300 hover:bg-gray-800 transition-all ${activeSectionIndex === sections.length - 1 && "opacity-50"}`}
