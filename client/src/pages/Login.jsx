   ...
   return (
      <div className="flex items-center justify-center min-h-screen bg-black">
         <form
            ...
            className="sm:w-[350px] w-full text-center border border-gray-800 rounded-2xl px-8 bg-gray-900"
         >
            ...
            {state !== "login" && (
               <div className="flex items-center mt-6 w-full bg-gray-800 border border-gray-700 h-12 rounded-full overflow-hidden pl-6 gap-2">
                  ...
                  <input
                     ...
                     name="name"
                     placeholder="Name"
                     className="border-none outline-none ring-0 bg-gray-800 text-gray-100"
                     value={formData.name}
            ...
            <button
               type="submit"
               className="mt-2 w-full h-11 rounded-full text-white bg-green-600 hover:bg-green-700 transition-colors"
            >
               {state === "login" ? "Login" : "Sign up"}
            </button>
            <p
